...
export class ExpenseController {
  ...
  @Post('expense')
  async createExpense(@Body() expenseData: { name: string; amount_total?: number; date: any; sharecount_id: number }): Promise<Expense> {
    const { name, amount_total, date, sharecount_id } = expenseData
